export default function Footer() {
  return (
    <footer
      id="footer"
      className="z-20 grid grid-cols-2 items-center gap-2 bg-slate-100 p-1 text-xs shadow-[1px_-1px_2px_0px_rgb(0,0,0,0.75)] shadow-black/30 md:flex"
    >
      ...
      <div className="flex-1 text-center">
        ...
        SUBSECRETARIA DA TECNOLOGIA DA INFORMAÇÃO - PREFEITURA MUNICIPAL DE
        MESQUITA - RJ
      </div>
      <div className="flex-1 text-center">
        RUA ARTHUR OLIVEIRA VECCHI, 120 - CENTRO - MESQUITA - RJ - CEP:
        26553-080
      </div>
      <div className="flex-1 text-center">
        <a
