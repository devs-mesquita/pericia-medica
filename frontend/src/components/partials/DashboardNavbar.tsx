      ...
      <div className="relative z-20 flex h-[48px] items-center justify-between border-b border-black/20 bg-slate-200 text-xs shadow-[1px_2px_2px_0px_rgb(0,0,0,0.75)] shadow-black/30 md:text-sm">
        ...
        <div className="group flex h-full items-center p-2 hover:cursor-pointer">
          ...
          >
            ...
            <div
              id="dropdown-menu"
              className="text-md absolute right-0 top-full hidden min-w-[192px] border border-black/20 bg-slate-200 font-semibold text-slate-600 shadow shadow-black/20 group-hover:flex group-hover:flex-col"
            >
              <Link
                to="/changepassword"
                className="flex items-center justify-between border-b border-black/25 p-3 hover:bg-slate-300"
                title="Alterar senha."
              >
              ...
              <button
                ...
                className="flex items-center justify-between p-3 hover:bg-slate-300"
